...
namespace GW2_SCT {
	const std::map<MessageCategory, const std::map<MessageType, receiver_information>> receiverInformationPerCategoryAndType = {
		{ MessageCategory::PLAYER_OUT, {
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::PHYSICAL, Messages_Type_Physical, "Message_Player_Outgoing_Physical", Message_Player_Out_Physical, P99_PROTECT({'v', 'n', 's', 'i'}), true, "FFFFFF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::CRIT, Messages_Type_Crit, "Message_Player_Outgoing_Crit", Message_Player_Out_Crit, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "FFFFFF", 0, -2.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::BLEEDING, Messages_Type_Bleeding, "Message_Player_Outgoing_Bleeding", Message_Player_Out_Bleeding, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "E84B30", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::BURNING, Messages_Type_Burning, "Message_Player_Outgoing_Burning", Message_Player_Out_Burning, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "FF9E32", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::POISON, Messages_Type_Poison, "Message_Player_Outgoing_Poison", Message_Player_Out_Poison, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "00C400", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::CONFUSION, Messages_Type_Confusion, "Message_Player_Outgoing_Confusion", Message_Player_Out_Confusion, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "B243FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::RETALIATION, Messages_Type_Retaliation, "Message_Player_Outgoing_Retaliation", Message_Player_Out_Retaliation, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "FFED00", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::TORMENT, Messages_Type_Torment, "Message_Player_Outgoing_Torment", Message_Player_Out_Torment, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "24451F", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::DOT, Messages_Type_Dot, "Message_Player_Outgoing_DoT", Message_Player_Out_DoT, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "45CDFF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::HEAL, Messages_Type_Heal, "Message_Player_Outgoing_Heal", Message_Player_Out_Heal, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "10FB10", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::HOT, Messages_Type_Hot, "Message_Player_Outgoing_HoT", Message_Player_Out_HoT, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "10FB10", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::SHIELD_RECEIVE, Messages_Type_Shield_Receive, "Message_Player_Outgoing_Shield_Got", Message_Player_Out_Shield_Got, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "FFFF00", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::SHIELD_REMOVE, Messages_Type_Shield_Remove, "Message_Player_Outgoing_Shield", Message_Player_Out_Shield, P99_PROTECT({ 'v', 'n', 's', 'i' }), true, "FFFF00", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::BLOCK, Messages_Type_Block, "Message_Player_Outgoing_Block", Message_Player_Out_Block, P99_PROTECT({ 'n', 's', 'i' }), true, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::EVADE, Messages_Type_Evade, "Message_Player_Outgoing_Evade", Message_Player_Out_Evade, P99_PROTECT({ 'n', 's', 'i' }), true, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::INVULNERABLE, Messages_Type_Invulnerable, "Message_Player_Outgoing_Invulnerable", Message_Player_Out_Invulnerable, P99_PROTECT({ 'n', 's', 'i' }), true, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_OUT, Messages_Category_Player_Out, MessageType::MISS, Messages_Type_Miss, "Message_Player_Outgoing_Miss", Message_Player_Out_Miss, P99_PROTECT({ 'n', 's', 'i' }), true, "0000FF", 0, -1.f)
		} },
		{ MessageCategory::PLAYER_IN, {
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::PHYSICAL, Messages_Type_Physical, "Message_Player_Incoming_Physical", Message_Player_In_Physical, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::CRIT, Messages_Type_Crit, "Message_Player_Incoming_Crit", Message_Player_In_Crit, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -2.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::BLEEDING, Messages_Type_Bleeding, "Message_Player_Incoming_Bleeding", Message_Player_In_Bleeding, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::BURNING, Messages_Type_Burning, "Message_Player_Incoming_Burning", Message_Player_In_Burning, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::POISON, Messages_Type_Poison, "Message_Player_Incoming_Poison", Message_Player_In_Poison, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::CONFUSION, Messages_Type_Confusion, "Message_Player_Incoming_Confusion", Message_Player_In_Confusion, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::RETALIATION, Messages_Type_Retaliation, "Message_Player_Incoming_Retaliation", Message_Player_In_Retaliation, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::TORMENT, Messages_Type_Torment, "Message_Player_Incoming_Torment", Message_Player_In_Torment, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::DOT, Messages_Type_Dot, "Message_Player_Incoming_DoT", Message_Player_In_DoT, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FF0000", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::HEAL, Messages_Type_Heal, "Message_Player_Incoming_Heal", Message_Player_In_Heal, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "10FB10", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::HOT, Messages_Type_Hot, "Message_Player_Incoming_HoT", Message_Player_In_HoT, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "10FB10", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::SHIELD_RECEIVE, Messages_Type_Shield_Receive, "Message_Player_Incoming_Shield_Got", Message_Player_In_Shield_Got, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FFFF00", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::SHIELD_REMOVE, Messages_Type_Shield_Remove, "Message_Player_Incoming_Shield", Message_Player_In_Shield, P99_PROTECT({ 'v', 'n', 's', 'c', 'r', 'i' }), true, "FFFF00", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::BLOCK, Messages_Type_Block, "Message_Player_Incoming_Block", Message_Player_In_Block, P99_PROTECT({ 'n', 's', 'c', 'r', 'i' }), true, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::EVADE, Messages_Type_Evade, "Message_Player_Incoming_Evade", Message_Player_In_Evade, P99_PROTECT({ 'n', 's', 'c', 'r', 'i' }), true, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::INVULNERABLE, Messages_Type_Invulnerable, "Message_Player_Incoming_Invulnerable", Message_Player_In_Invulnerable, P99_PROTECT({ 'n', 's', 'c', 'r', 'i' }), true, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PLAYER_IN, Messages_Category_Player_In, MessageType::MISS, Messages_Type_Miss, "Message_Player_Incoming_Miss", Message_Player_In_Miss, P99_PROTECT({ 'n', 's', 'c', 'r', 'i' }), true, "0000FF", 0, -1.f)
		} },
		{ MessageCategory::PET_OUT, {
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::PHYSICAL, Messages_Type_Physical, "Message_Pet_Outgoing_Physical", Message_Pet_Out_Physical, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::CRIT, Messages_Type_Crit, "Message_Pet_Outgoing_Crit", Message_Pet_Out_Crit, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -2.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::BLEEDING, Messages_Type_Bleeding, "Message_Pet_Outgoing_Bleeding", Message_Pet_Out_Bleeding, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::BURNING, Messages_Type_Burning, "Message_Pet_Outgoing_Burning", Message_Pet_Out_Burning, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::POISON, Messages_Type_Poison, "Message_Pet_Outgoing_Poison", Message_Pet_Out_Poison, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::CONFUSION, Messages_Type_Confusion, "Message_Pet_Outgoing_Confusion", Message_Pet_Out_Confusion, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::RETALIATION, Messages_Type_Retaliation, "Message_Pet_Outgoing_Retaliation", Message_Pet_Out_Retaliation, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::TORMENT, Messages_Type_Torment, "Message_Pet_Outgoing_Torment", Message_Pet_Out_Torment, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::DOT, Messages_Type_Dot, "Message_Pet_Outgoing_DoT", Message_Pet_Out_DoT, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::HEAL, Messages_Type_Heal, "Message_Pet_Outgoing_Heal", Message_Pet_Out_Heal, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::HOT, Messages_Type_Hot, "Message_Pet_Outgoing_HoT", Message_Pet_Out_HoT, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::SHIELD_RECEIVE, Messages_Type_Shield_Receive, "Message_Pet_Outgoing_Shield_Got", Message_Pet_Out_Shield_Got, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), true, "FFFF00", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::SHIELD_REMOVE, Messages_Type_Shield_Remove, "Message_Pet_Outgoing_Shield", Message_Pet_Out_Shield, P99_PROTECT({ 'v', 'n', 's', 'p', 'i' }), false, "FFFF00", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::BLOCK, Messages_Type_Block, "Message_Pet_Outgoing_Block", Message_Pet_Out_Block, P99_PROTECT({ 'n', 's', 'p', 'i' }), false, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::EVADE, Messages_Type_Evade, "Message_Pet_Outgoing_Evade", Message_Pet_Out_Evade, P99_PROTECT({ 'n', 's', 'p', 'i' }), false, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::INVULNERABLE, Messages_Type_Invulnerable, "Message_Pet_Outgoing_Invulnerable", Message_Pet_Out_Invulnerable, P99_PROTECT({ 'n', 's', 'p', 'i' }), false, "0000FF", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_OUT, Messages_Category_Pet_Out, MessageType::MISS, Messages_Type_Miss, "Message_Pet_Outgoing_Miss", Message_Pet_Out_Miss, P99_PROTECT({ 'n', 's', 'p', 'i' }), false, "0000FF", 0, -1.f)
		} },
		{ MessageCategory::PET_IN, {
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::PHYSICAL, Messages_Type_Physical, "Message_Pet_Incoming_Physical", Message_Pet_In_Physical, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::CRIT, Messages_Type_Crit, "Message_Pet_Incoming_Crit", Message_Pet_In_Crit, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -2.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::BLEEDING, Messages_Type_Bleeding, "Message_Pet_Incoming_Bleeding", Message_Pet_In_Bleeding, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::BURNING, Messages_Type_Burning, "Message_Pet_Incoming_Burning", Message_Pet_In_Burning, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::POISON, Messages_Type_Poison, "Message_Pet_Incoming_Poison", Message_Pet_In_Poison, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::CONFUSION, Messages_Type_Confusion, "Message_Pet_Incoming_Confusion", Message_Pet_In_Confusion, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::RETALIATION, Messages_Type_Retaliation, "Message_Pet_Incoming_Retaliation", Message_Pet_In_Retaliation, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::TORMENT, Messages_Type_Torment, "Message_Pet_Incoming_Torment", Message_Pet_In_Torment, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::DOT, Messages_Type_Dot, "Message_Pet_Incoming_DoT", Message_Pet_In_DoT, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::HEAL, Messages_Type_Heal, "Message_Pet_Incoming_Heal", Message_Pet_In_Heal, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::HOT, Messages_Type_Hot, "Message_Pet_Incoming_HoT", Message_Pet_In_HoT, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::SHIELD_RECEIVE, Messages_Type_Shield_Receive, "Message_Pet_Incoming_Shield_Got", Message_Pet_In_Shield_Got, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), true, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::SHIELD_REMOVE, Messages_Type_Shield_Remove, "Message_Pet_Incoming_Shield", Message_Pet_In_Shield, P99_PROTECT({ 'v', 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::BLOCK, Messages_Type_Block, "Message_Pet_Incoming_Block", Message_Pet_In_Block, P99_PROTECT({ 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::EVADE, Messages_Type_Evade, "Message_Pet_Incoming_Evade", Message_Pet_In_Evade, P99_PROTECT({ 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::INVULNERABLE, Messages_Type_Invulnerable, "Message_Pet_Incoming_Invulnerable", Message_Pet_In_Invulnerable, P99_PROTECT({ 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f),
			ReceiverInformation(MessageCategory::PET_IN, Messages_Category_Pet_In, MessageType::MISS, Messages_Type_Miss, "Message_Pet_Incoming_Miss", Message_Pet_In_Miss, P99_PROTECT({ 'n', 's', 'p', 'c', 'r', 'i' }), false, "80FB80", 0, -1.f)
		} }
	};
